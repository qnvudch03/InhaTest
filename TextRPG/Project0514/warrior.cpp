...
int PlayerClass::SetPlayerClass(PlayerClass& Youser)
{
	int WoriarClasses = 0;
...
void PlayerClass::MakePlayerClass(PlayerClass* Youser, int YouserNumber)
{
	for (int PlayerClass = 1; PlayerClass <= YouserNumber; PlayerClass++)
	{
		if (PlayerClass == WorialClass::warrior)
...
PlayerClass* PlayerClass::SwitchPlayerClass(PlayerClass* YouserArray)
{
	int choicePlayer = -1;
	PlayerClass* SellectedPlayer = nullptr;
